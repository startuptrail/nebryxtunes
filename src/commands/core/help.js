...
function getCommands() {
  return [
    ...
    { name: "maintance", description: "Global maintenance mode (bot owner only)", category: "Info", usage: "maintance start <time> [--affected=play,skip] [--allow=help,ping] | maintance end | maintance status | /maintance start|end|status", aliases: ["maintenance"] },
